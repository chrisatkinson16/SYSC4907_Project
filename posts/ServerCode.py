...
def transmission(field1=None, field2=None, field3=None, field4=None, field5=None, field6=None, field7=None,
                 field8=None):
    ...
    params = urllib.parse.urlencode(
        {'field1': field1, 'field2': field2, 'field3': field3, 'field4': field4, 'field5': field5, 'field6': field6,
         'field7': field7, 'field8': field8, 'key': key})
...
while True:
    ...
    if broken == 2:  # if there is no connection for 200 seconds then the loop ends.
        break
    if readHeadlessPi()['entry_id'] == (
            currentID + 1):  # if the RPi establishes a connection and reads values then the loop stops.
        break
    time.sleep(0.1)
